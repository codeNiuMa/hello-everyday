...
if __name__ == '__main__':
    # 微信配置
    wechat_config = {
        'appid': 'wxd20f4d4a82c58215',  # (No.1)此处填写你的appid
        'appsecret': '70f3a1b6d7b038a6ac46843c456730b1',  # (No.2)此处填写你的appsecret
        'template_id': 'LMIv28ktFcmKZ2Emfc3BEoeReIwcT-3a8zw6zQ1NB1g'  # (No.3)此处填写你的模板消息ID
    }

    # 用户列表
    openids = [
        'ogUs56vwaRyEidJ4z4T7uFAlTHUw',  # (No.4)此处填写你的微信号（微信公众平台上你的微信号）
        # 'xxxxx', #如果有多个用户也可以
        # 'xxxxx',
    ]
